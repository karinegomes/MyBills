<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav">
        ...
        <ul class="nav" id="side-menu">
            <li class="user-pro">
                <a href="javascript:void(0)" class="waves-effect"><img src="../plugins/images/users/varun.jpg"
            ...
            <li>
                <a href="{{ url('/') }}" class="waves-effect {{ $pageName == 'Dashboard' ? 'active' : '' }}">
                    <i class="mdi mdi-av-timer fa-fw"></i> <span class="hide-menu">Dashboard</span>
                </a>
            </li>

            <li>
                <a href="{{ route('expenses.index') }}"
                   class="waves-effect {{ $pageName == 'Expenses' ? 'active' : '' }}">
                    <i class="mdi mdi-currency-usd fa-fw"></i> <span class="hide-menu">Expenses</span>
                </a>
            </li>
            ...
            <li><a href="javascript:void(0)" class="waves-effect "><i class="mdi mdi-content-copy fa-fw"></i> <span
                ...
                <ul class="nav nav-second-level two-li">
                    ...
                    <li><a href="lightbox.html"><i class="ti-file fa-fw"></i> <span
                                    class="hide-menu">Lightbox Popup</span></a></li>
                    <li><a href="javascript:void(0)" class="waves-effect"><i class="icon-bulb fa-fw"></i> <span
                                    class="hide-menu">Icons<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-third-level">
                            <li><a href="fontawesome.html"><i class="fa-fw">F</i><span
                                            class="hide-menu">Font awesome</span></a>
                            </li>
                            <li><a href="themifyicon.html"><i class="fa-fw">T</i><span
                                            class="hide-menu">Themify Icons</span></a>
                            </li>
                            <li><a href="simple-line.html"><i class="fa-fw">S</i><span class="hide-menu">Simple line Icons</span></a>
                            </li>
                            <li><a href="material-icons.html"><i class="fa-fw">M</i><span class="hide-menu">Material Icons</span></a>
                            </li>
                    ...
                    <li><a href="treeview.html"><i class="ti-folder fa-fw"></i> <span
            ...
            <li class="mega-nav"><a href="javascript:void(0)" class="waves-effect"><i
                            class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">UI<span
            ...
            <li class="devider"></li>
            <li><a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-clipboard-text fa-fw"></i> <span
                ...
                <ul class="nav nav-second-level two-li">
                    ...
                    <li><a href="form-float-input.html"><i class="fa-fw">F</i><span
                                    class="hide-menu">Form Float Input</span></a>
                    </li>
            ...
            <li><a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-table fa-fw"></i> <span
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="responsive-tables.html"><i class="fa-fw">R</i><span
                                    class="hide-menu">Responsive Tables</span></a>
                    </li>
            ...
            <li class="last-nav"><a href="javascript:void(0)" class="waves-effect"><i
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-chart-bar fa-fw"></i>
                        ...
                        <ul class="nav nav-third-level">
                            ...
                            <li><a href="peity-chart.html"><i class="fa-fw">P</i><span
                                            class="hide-menu">Peity Charts</span></a>
                            </li>
                            ...
                            <li><a href="extra-charts.html"><i class="fa-fw">E</i><span
                                            class="hide-menu">Extra Charts</span></a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="map-google.html" class="waves-effect"><i
                                    class="mdi mdi-google-maps fa-fw"></i><span class="hide-menu">Google Map</span></a>
                    </li>
